...
@section('title', 'Business Referrals')
...
@section('content')
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				<h1 class="page-title">Business Referrals</h1>
			</div>
		</div>
					...
					<table id="datatable-buttons" class="table table-striped table-bordered">
						...
						@foreach($referrals as $referral)
							<tr>
								...
								@endif
								<td>{{ $referral->parent->first_name.' '.$referral->parent->last_name }}</td>
...
<!--					<a href="{{ route('site.ref.addBizReferrals') }}" role="button" class="btn btn-primary btn-md waves-effect waves-light">Add Referral</a>-->
				</div>
			</div>
		</div>
	</div>
