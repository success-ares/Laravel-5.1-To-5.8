...
@section('content')
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-8">
				<div class="card-box">
					<form class="form-horizontal" role="form" method="post" action="{{ route('site.ref.createBizReferrals') }}">
						{{ csrf_field() }}
						<div class="form-group">
							<label class="col-md-3 control-label" for="select_product">Select program</label>
							<div class="col-md-8">
								<select id="select_product" class="form-control" name="product_id">
						...
						<hr>
						<div class="form-group">
							<label class="col-md-3 control-label" for="input_seller_email">Seller Email</label>
							<div class="col-md-8">
								<input class="form-control" type="text" id="input_seller_email" name="seller_email" required>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label" for="input_seller_first_name">Seller First name</label>
							<div class="col-md-8">
								<input class="form-control" type="text" id="input_seller_first_name" name="seller_first_name" required>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label" for="input_seller_last_name">Seller Last name</label>
							<div class="col-md-8">
								<input class="form-control" type="text" id="input_seller_last_name" name="seller_last_name" required>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label" for="input_seller_address">Seller Address</label>
							<div class="col-md-8">
								<input class="form-control" type="text" id="input_seller_address" name="seller_address">
							</div>
						</div>
						<hr>
						<div class="form-group">
							<label class="col-md-3 control-label" for="input_email">Referral Email</label>
							<div class="col-md-8">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // search seller
            $( "#input_seller_email" ).autocomplete({
                source: "{{ route('site.ref.searchUser') }}",
                response: function (event, ui) {
                    if ( !ui.content.length ){
                        $('#input_seller_first_name').val('');
                        $('#input_seller_last_name').val('');
                        $('#input_seller_address').val('');
                    }
                },
                select: function( event, ui ) {
                    $('#input_seller_email').val(ui.item.email);
                    $('#input_seller_first_name').val(ui.item.first_name);
                    $('#input_seller_last_name').val(ui.item.last_name);
                    $('#input_seller_address').val(ui.item.address);
                },
                minLength: 3,
                delay: 500
            });
